...
static char* K_INPUT_CHANGE_BAUD_RATE_PARAMS= "%d,%d";

typedef struct{
  uint32_t id;
}k_input_get_firmware_version;
#define K_INPUT_GET_FIRMWARE_VERSION_N_PARAMS 1
static char* K_INPUT_GET_FIRMWARE_VERSION_PARAMS = "%d";

typedef struct{
  uint32_t id;
}k_input_get_kitra_status;
#define K_INPUT_GET_KITRA_STATUS_N_PARAMS 1
static char* K_INPUT_GET_KITRA_STATUS_PARAMS = "%d";
...
static char* K_INPUT_KITRA_RESET_PARAMS = "%d,%hhd";
...
static char* K_INPUT_KITRA_SLEEP_PARAMS = "%d,%hhd";
...
static char* K_INPUT_DI_ENABLE_DISABLE_PARAMS = "%d,%hhd,%hhd,%hhd";
...
static char* K_INPUT_DI_READ_STATE_PARAMS = "%d,%hhd";
...
static char* K_INPUT_DI_CONFIGURE_ACTIVATION_PARAMS = "%d,%hhd,%hhd,%hhd,%d,%hd";
...
static char* K_INPUT_ADC_ENABLE_DISABLE_PARAMS = "%d,%hhd,%hhd";
...
static char* K_INPUT_ADC_CHANGE_MODE_PARAMS = "%d,%hhd,%hhd";
...
static char* K_INPUT_ADC_CHANGE_CONFIGURATION_PARAMS = "%d,%hhd,%d,%hd,%hd";
...
static char* K_INPUT_ADC_READ_LAST_SAMPLE_PARAMS = "%d,%hhd";
...
static char* K_INPUT_ADC_SET_NOTIFICATION_PARAMS = "%d,%hhd,%hhd,%hd,%hhd";
...
static char* K_INPUT_DO_ENABLE_DISABLE_PARAMS = "%d,%hhd,%hhd,%hhd";
...
static char* K_INPUT_DO_CHANGE_STATE_PARAMS = "%d,%hhd,%hhd";
...
static char* K_INPUT_DO_INIT_PWM_PARAMS = "%d,%hhd,%d,%hhd,%hhd";
...
static char* K_INPUT_DO_CHANGE_MODE_PWM_PARAMS = "%d,%hhd,%hhd";
...
static char* K_INPUT_CAP_ENABLE_DISABLE_PARAMS = "%d,%hhd,%hhd,%hhd";
...
static char* K_INPUT_CAP_READ_STATE_PARAMS = "%d,%hhd";
...
static char* K_INPUT_CAP_CONFIGURE_NOTIFICATIONS_PARAMS = "%d,%hhd,%hhd,%hhd,%hhd,%hd";
...
static char* K_INPUT_CAP_CONFIGURE_PARAMS = "%d,%d";
...
static char* K_INPUT_HAPTIC_ENABLE_DISABLE_PARAMS = "%d,%hhd,%hhd";
...
static char* K_INPUT_HAPTIC_CONFIGURATION_PARAMS = "%d,%hhd,%hhd,%hhd,%hhd,%hhd";
...
static char* K_INPUT_HAPTIC_CHANGE_MODE_PARAMS = "%d,%hhd,%hhd";
...
static char* K_INPUT_LUX_ENABLE_DISABLE_PARAMS = "%d,%hhd,%hhd";
...
static char* K_INPUT_LUX_READ_LUX_PARAMS = "%d,%hhd";
...
static char* K_INPUT_LUX_READ_PROX_PARAMS = "%d,%hhd";
...
static char* K_INPUT_LUX_SENSOR_CONFIGURATION_PARAMS = "%d,%hhd,%hhd,%hhd,%hhd";
...
static char* K_INPUT_LUX_SENSOR_NOTIFICATIONS_PARAMS = "%d,%hhd,%hhd,%d,%d,%f,%hhd,%hhd";
...
static char* K_INPUT_LUX_SENSOR_MANAGED_NOTIFICATIONS_PARAMS = "%d,%hhd";
...
static char* K_INPUT_LDRGB_ENABLE_DISABLE_PARAMS = "%d,%hhd,%hhd";
...
static char* K_INPUT_LDRGB_SET_PARAMS = "%d,%hhd,%X,%hhd,%hhd";
...
#define K_INPUT_LDRGB_SET_MANAGED_N_PARAMS 5
static char* K_INPUT_LDRGB_SET_MANAGED_PARAMS = "%d,%hhd,%X,%hhd,%hhd";
...
static char* K_INPUT_LDRGB_CHANGE_MODE_PARAMS = "%d,%hhd,%hhd";
...
static char* K_INPUT_POS_ENABLE_DISABLE_PARAMS = "%d,%hhd";
...
static char* K_INPUT_POS_READ_RAW_PARAMS = "%d,%hX";

typedef struct{
  uint32_t id;
}k_input_pos_read_euler_angles;
#define K_INPUT_POS_READ_EULER_ANGLES_N_PARAMS 1
static char* K_INPUT_POS_READ_EULER_ANGLES_PARAMS = "%d";
...
static char* K_INPUT_POS_CONFIGURATION_PARAMS = "%d,%hhd,%hX,%hhd,%d,%hd,%hhd";

typedef struct{
  uint32_t id;
}k_input_pos_read_calibration_state;
#define K_INPUT_POS_READ_CALIBRATION_STATE_N_PARAMS 1
static char* K_INPUT_POS_READ_CALIBRATION_STATE_PARAMS = "%d";

typedef struct{
  uint32_t id;
}k_input_pos_read_step_counter;
#define K_INPUT_POS_READ_STEP_COUNTER_N_PARAMS 1
static char* K_INPUT_POS_READ_STEP_COUNTER_PARAMS = "%d";
...
static char* K_INPUT_ENV_ENABLE_DISABLE_PARAMS = "%d,%hhd,%hhX";
...
static char* K_INPUT_ENV_READ_VALUE_PARAMS = "%d,%hhd";
...
static char* K_INPUT_ENV_ENABLE_NOTIFICATION_PARAMS = "%d,%hhd,%hhd,%hhd,%hhd,%f";
...
static char* K_INPUT_MIC_ENABLE_DISABLE_PARAMS = "%d,%hhd,%hhX,%hhd,%d";

typedef struct{
  uint32_t id;
}k_input_mic_get_localization_angle;
#define K_INPUT_MIC_GET_LOCALIZATION_ANGLE_N_PARAMS 1
static char* K_INPUT_MIC_GET_LOCALIZATION_ANGLE_PARAMS = "%d";
...
static char* K_INPUT_BUZZ_ENABLE_DISABLE_PARAMS = "%d,%hhd";
...
static char* K_INPUT_BUZZ_CHANGE_STATE_PARAMS = "%d,%d,%hhd,%d"; 

typedef struct{
  uint32_t id;
}k_input_start_fw_update;
#define K_INPUT_START_FW_UPDATE_N_PARAMS 1
static char* K_INPUT_START_FW_UPDATE_PARAMS = "%d";
...
static char* K_INPUT_I2C_READ_PARAMS = "%d,%hhX,%hhX,%hhX,%hhd";
...
static char* K_INPUT_I2C_WRITE_PARAMS = "%d,%hhX,%hhX,%hhX,%hhX,%hhX,%hhX,%hhX";
