...
bool k_send_packet(void* k_obj, uint32_t optional_mask)
{
  ...
  case K_OUTPUT_ACK:
    ...
    break;
  case K_OUTPUT_NACK:
    strcpy(format,K_OUTPUT_NACK_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_FIRMWARE_VERSION:
    strcpy(format,K_OUTPUT_FIRMWARE_VERSION_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_GET_KITRA_STATUS_RESPONSE:
    strcpy(format,K_OUTPUT_GET_KITRA_STATUS_RESPONSE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
 ...
 //DI
  case K_OUTPUT_DI_READ_STATE:
    strcpy(format,K_OUTPUT_DI_READ_STATE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_DI_STATE_NOTIFICATION:
    strcpy(format,K_OUTPUT_DI_STATE_NOTIFICATION_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_ADC_READ_SAMPLE_RESPONSE:
    strcpy(format,K_OUTPUT_ADC_READ_SAMPLE_RESPONSE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_ADC_SAMPLE_NOTIFICATION:
    strcpy(format,K_OUTPUT_ADC_SAMPLE_NOTIFICATION_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_ADC_THRESHOLD_NOTIFICATION:
    strcpy(format,K_OUTPUT_ADC_THRESHOLD_NOTIFICATION_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_CAP_READ_STATE_RESPONSE:
    strcpy(format,K_OUTPUT_CAP_READ_STATE_RESPONSE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_CAP_NOTIFICATION:
    strcpy(format,K_OUTPUT_CAP_NOTIFICATION_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_LUX_READ_LUX_RESPONSE:
    strcpy(format,K_OUTPUT_LUX_READ_LUX_RESPONSE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_LUX_READ_PROX_RESPONSE:
    strcpy(format,K_OUTPUT_LUX_READ_PROX_RESPONSE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_LUX_NOTIFICATION:
    strcpy(format,K_OUTPUT_LUX_NOTIFICATION_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_LUX_MANAGED_NOTIFICATION:
    strcpy(format,K_OUTPUT_LUX_MANAGED_NOTIFICATION_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_POS_READ_RAW_RESPONSE:
    strcpy(format,K_OUTPUT_POS_READ_RAW_RESPONSE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_POS_NOTIFICATION_RAW:
    strcpy(format,K_OUTPUT_POS_NOTIFICATION_RAW_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
             ((k_output_pos_read_raw_response*) k_obj)->id,
             ((k_output_pos_read_raw_response*) k_obj)->acc_x,
             ((k_output_pos_read_raw_response*) k_obj)->acc_y,
  ...
  case K_OUTPUT_POS_NOTIFICATION_EULER:
    strcpy(format,K_OUTPUT_POS_NOTIFICATION_EULER_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_POS_MANAGED_NOTIFICATION:
    strcpy(format,K_OUTPUT_POS_MANAGED_NOTIFICATION_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_POS_READ_CALIBRATION_STATE_RESPONSE:
    strcpy(format,K_OUTPUT_POS_READ_CALIBRATION_STATE_RESPONSE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_POS_READ_STEP_COUNTER_RESPONSE:
    strcpy(format,K_OUTPUT_POS_READ_STEP_COUNTER_RESPONSE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_ENV_READ_VALUE_RESPONSE:
    strcpy(format,K_OUTPUT_ENV_READ_VALUE_RESPONSE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_ENV_NOTIFICATION:
    strcpy(format,K_OUTPUT_ENV_NOTIFICATION_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_MIC_GET_LOCALIZATION_RESPONSE:
    strcpy(format,K_OUTPUT_MIC_GET_LOCALIZATION_RESPONSE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_ENV_THRESHOLD_NOTIFICATION:
    strcpy(format,K_OUTPUT_ENV_THRESHOLD_NOTIFICATION_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_OUTPUT_I2C_READ_RESPONSE:
    strcpy(format,K_OUTPUT_I2C_READ_RESPONSE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_INPUT_POS_ENABLE_DISABLE:
    strcpy(format, K_INPUT_POS_ENABLE_DISABLE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_INPUT_POS_READ_RAW:
    strcpy(format, K_INPUT_POS_READ_RAW_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_INPUT_POS_READ_EULER_ANGLES:
    strcpy(format, K_INPUT_POS_READ_EULER_ANGLES_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_INPUT_POS_CONFIGURATION:
    strcpy(format, K_INPUT_POS_CONFIGURATION_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_INPUT_POS_READ_CALIBRATION_STATE:
    strcpy(format, K_INPUT_POS_READ_CALIBRATION_STATE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_INPUT_ENV_ENABLE_DISABLE:
    strcpy(format, K_INPUT_ENV_ENABLE_DISABLE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_INPUT_ENV_READ_VALUE:
    strcpy(format, K_INPUT_ENV_READ_VALUE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_INPUT_ENV_ENABLE_NOTIFICATION:
    strcpy(format, K_INPUT_ENV_ENABLE_NOTIFICATION_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_INPUT_MIC_ENABLE_DISABLE:
    strcpy(format, K_INPUT_MIC_ENABLE_DISABLE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_INPUT_BUZZ_ENABLE_DISABLE:
    strcpy(format, K_INPUT_BUZZ_ENABLE_DISABLE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_INPUT_BUZZ_CHANGE_STATE:
    strcpy(format, K_INPUT_BUZZ_CHANGE_STATE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_INPUT_I2C_READ:
    strcpy(format, K_INPUT_I2C_READ_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
  ...
  case K_INPUT_I2C_WRITE:
    strcpy(format, K_INPUT_I2C_WRITE_PARAMS);
    kitra_generate_packet(buffer_tx,MAX_BUFFER_SIZE,format,optional_mask,
